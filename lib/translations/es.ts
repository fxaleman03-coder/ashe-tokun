...
const es: Translation = {
  ...
  nav: {
    links: ["Inicio", "Tienda", "Tradiciones", "Colecciones"],
    cta: "Visitar Tienda",
  },
  hero: {
    label: "ASHE TOKUN",
  ...
  storefront: {
    categorySection: {
      homeLabel: "Comprar por Colección",
      homeHeading: "Explora nuestras colecciones",
      homeSubtitle:
        "Entra a la tienda por colecciones de productos enfocadas, cada una curada para descubrir con claridad.",
      shopLabel: "Colecciones",
      shopHeading: "Colecciones",
      shopSubtitle:
        "Explora colecciones por tipo de producto entre artículos espirituales, herramientas ceremoniales, piezas artesanales y elementos devocionales.",
      viewCategory: "Ver Colección",
      productSingular: "Producto",
      productPlural: "Productos",
      noCategoriesTitle: "No hay colecciones disponibles",
      noCategoriesAvailable:
        "Las colecciones de productos se están preparando para la tienda.",
      featuredCategory: "Colección Destacada",
      availableOnline: "Disponible en Línea",
      category: "Colección",
      categories: "Colecciones",
      genericCategoryDescription:
        "Explora esta colección de ASHE TOKUN a medida que nuevos productos estén disponibles.",
    },
    categoryPage: {
  ...
  admin: {
    ...
    products: {
      ...
      availabilityChannels: "Disponibilidad de Venta",
      availableOnline: "Disponible en Línea",
      availableInPos: "Disponible en POS",
      inventory: "Inventario",
      table: {
        select: "Seleccionar",
        product: "Producto",
        ...
        restoreToActive: "Restaurar como Activo",
        publishSelected: "Publicar Seleccionados",
        archiveSelected: "Archivar Seleccionados",
        moveSelectedToDraft: "Mover Seleccionados a Borrador",
        statusUpdateSuccess:
          "Se actualizaron {count} estados de productos.",
        statusUpdateFailed: "Falló la actualización del estado del producto",
        noStatusChanges: "No fue necesario cambiar ningún estado.",
        featured: "Destacado",
        edit: "Editar",
    ...
    productIdentification: {
      ...
      internalBarcode: "Código de Barras Interno",
      code128: "Code 128",
      code128Preview: "Vista Previa Code 128",
      notUpcEanGtin: "Código interno de ASHE TOKUN. No es UPC, EAN ni GTIN.",
      barcodeValue: "Valor del Código de Barras",
      sku: "SKU",
      shelfLabel: "Etiqueta de Estante",
      productLabel: "Etiqueta de Producto",
      miniProductLabel: "Etiqueta Mini de Producto",
      printLabels: "Imprimir Etiquetas",
      printProductLabel: "Imprimir Etiqueta de Producto",
      printShelfLabel: "Imprimir Etiqueta de Estante",
      printMiniLabel: "Imprimir Etiqueta Mini",
      preview: "Vista Previa de Etiquetas",
      previewDescription:
        "Revise las etiquetas antes de imprimir. El conteo de impresión se actualiza solo cuando se usa la acción Imprimir.",
      cancel: "Cancelar",
      labelType: "Tipo de Etiqueta",
      copiesPerProduct: "Copias por Producto",
    ...
    media: {
      ...
      edit: "Editar",
      details: "Detalles",
      editTitle: "Editar Archivo Multimedia",
      editDescription:
        "Actualice los metadatos sin cambiar el archivo almacenado ni su URL pública.",
      displayFilename: "Nombre Visible del Archivo",
      filenameHelp: "Se conservará la extensión original del archivo.",
      unassigned: "Sin Asignar",
      activeStatus: "Activo",
      activeHelp:
        "Los archivos inactivos conservan sus vínculos con productos, pero se ocultan de las vistas activas.",
      storagePathLocked: "Ruta de Almacenamiento (Solo lectura)",
      storagePathLockedHelp:
        "Los objetos almacenados y las URL públicas no se renombran en esta fase.",
      cancel: "Cancelar",
      saveChanges: "Guardar Cambios",
      savingChanges: "Guardando...",
      updateSuccess: "El archivo multimedia se actualizó correctamente.",
      localReadOnly:
        "Los archivos locales de respaldo son de solo lectura. Súbalos a Supabase antes de editarlos.",
      blankFilenameError: "Ingrese un nombre de archivo válido.",
      duplicateFilenameError: "Otro archivo multimedia ya usa este nombre.",
      invalidAssetTypeError: "Seleccione un tipo de archivo válido.",
      invalidBrandError: "Seleccione una marca activa válida.",
      updateError: "No se pudo actualizar el archivo multimedia.",
      serviceUnavailableError: "El servicio multimedia no está configurado.",
      unauthorizedError: "No tiene permiso para editar archivos multimedia.",
      delete: "Eliminar",
      deleting: "Eliminando...",
    },
    pos: {
    ...
    inventory: {
      ...
      initializeInventory: "Inicializar Inventario",
      initializing: "Inicializando...",
      initializationComplete: "El inventario se inicializó correctamente.",
      initializationFailed: "Falló la inicialización del inventario",
      metrics: {
