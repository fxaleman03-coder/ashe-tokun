  ...
  admin: {
    ...
    products: {
      ...
      table: {
        ...
        moveSelectedToDraft: string;
        statusUpdateSuccess: string;
        statusUpdateFailed: string;
        noStatusChanges: string;
        featured: string;
        edit: string;
        barcode: string;
        readyToShip: string;
    ...
    media: {
      ...
      activeStatus: string;
      activeHelp: string;
      storagePathLocked: string;
      storagePathLockedHelp: string;
      cancel: string;
      saveChanges: string;
      savingChanges: string;
      updateSuccess: string;
      localReadOnly: string;
      blankFilenameError: string;
      duplicateFilenameError: string;
      invalidAssetTypeError: string;
      invalidBrandError: string;
      updateError: string;
