...
const en: Translation = {
  ...
  admin: {
    ...
    products: {
      ...
      availabilityChannels: "Sales Availability",
      availableOnline: "Available Online",
      ...
      table: {
        ...
        moveSelectedToDraft: "Move Selected to Draft",
        statusUpdateSuccess: "{count} product status updates completed.",
        statusUpdateFailed: "Product status update failed",
        noStatusChanges: "No product statuses needed to change.",
        featured: "Featured",
        edit: "Edit",
        barcode: "Barcode",
    ...
    media: {
      ...
      editDescription:
        "Update asset metadata without changing the stored file or its public URL.",
      displayFilename: "Display Filename",
      filenameHelp: "The original file extension will be preserved.",
      unassigned: "Unassigned",
      activeStatus: "Active",
      activeHelp:
        "Inactive assets remain linked to products but are hidden from active media views.",
      storagePathLocked: "Storage Path (Read-only)",
      storagePathLockedHelp:
        "Storage objects and public URLs are not renamed during this phase.",
      cancel: "Cancel",
      saveChanges: "Save Changes",
      savingChanges: "Saving...",
      updateSuccess: "Media asset updated successfully.",
      localReadOnly:
        "Local fallback assets are read-only. Upload the asset to Supabase before editing.",
      blankFilenameError: "Enter a valid filename.",
      duplicateFilenameError: "Another media asset already uses this filename.",
      invalidAssetTypeError: "Select a valid asset type.",
      invalidBrandError: "Select a valid active brand.",
      updateError: "The media asset could not be updated.",
      serviceUnavailableError: "The media service is not configured.",
      unauthorizedError: "You do not have permission to edit media assets.",
      delete: "Delete",
      deleting: "Deleting...",
    },
    pos: {
    ...
    inventory: {
      ...
      initializeInventory: "Initialize Inventory",
      initializing: "Initializing...",
      initializationComplete: "Inventory initialized successfully.",
      initializationFailed: "Inventory initialization failed",
      metrics: {
